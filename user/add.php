...
<?php
	...
	session_start();
		...
		$FID = $_REQUEST["to_id"];
		$TID = $_REQUEST["form_id"];
		
		 
date_default_timezone_set('Asia/Dhaka');
		
			$insertQuery = "INSERT INTO friend_table VALUE(NULL,'$FID','$TID','NOTFRIENDS','".date('d-m-y')."')";
            ...
            echo "<script type='text/javascript'>alert('Request Sent'); window.location='find_friend.php';</script>";
